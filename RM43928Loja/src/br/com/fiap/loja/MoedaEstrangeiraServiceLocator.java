...
public class MoedaEstrangeiraServiceLocator extends org.apache.axis.client.Service implements br.com.fiap.loja.MoedaEstrangeiraService {
    ...
    private java.lang.String MoedaEstrangeira_address = "http://10.3.1.6:8080/rm43928Kiosque/services/MoedaEstrangeira";
    ...
    public br.com.fiap.loja.MoedaEstrangeira getMoedaEstrangeira() throws javax.xml.rpc.ServiceException {
    ...
    public br.com.fiap.loja.MoedaEstrangeira getMoedaEstrangeira(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.com.fiap.loja.MoedaEstrangeiraSoapBindingStub _stub = new br.com.fiap.loja.MoedaEstrangeiraSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (br.com.fiap.loja.MoedaEstrangeira.class.isAssignableFrom(serviceEndpointInterface)) {
                br.com.fiap.loja.MoedaEstrangeiraSoapBindingStub _stub = new br.com.fiap.loja.MoedaEstrangeiraSoapBindingStub(new java.net.URL(MoedaEstrangeira_address), this);
                _stub.setPortName(getMoedaEstrangeiraWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://loja.fiap.com.br", "MoedaEstrangeiraService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://loja.fiap.com.br", "MoedaEstrangeira"));
        }
